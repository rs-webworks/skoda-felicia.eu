...
class Version20170207194216 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        $this->addSql(<<<TAG
                    ...
                    (36, 2, 'Dobití akumulátoru', '<p>Akumulátory, které se delší dobu nepoužívají se mohou samovolně vybít a navíc může dojít k sulfatizaci článků.</p>
<ul>
